...
class ValveControl(QtWidgets.QWidget):
    def __init__(self, parent, valveName:any):
        ...
        self.grid.addWidget(self.DelayTimeLabel, 10, 0)
        self.grid.addWidget(self.DelayTimeLineEdit, 10, 1)
        self.grid.addWidget(self.sampleButton, 11, 0)
        self.grid.addWidget(self.setDelayButton, 11, 1)
